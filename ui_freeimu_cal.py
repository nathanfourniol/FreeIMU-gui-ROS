...
class Ui_FreeIMUCal(object):
    def setupUi(self, FreeIMUCal):
        ...
        FreeIMUCal.setEnabled(True)
        FreeIMUCal.resize(840, 840)
        ...
        FreeIMUCal.setMinimumSize(QtCore.QSize(840, 840))
        FreeIMUCal.setMaximumSize(QtCore.QSize(840, 840))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 829, 95))
        ...
        self.gridLayout.addWidget(self.calAlgorithmComboBox, 0, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.calibrateButton, 0, 10, 1, 1)
        self.imuTopicEdit = QtGui.QLineEdit(self.gridLayoutWidget)
        self.imuTopicEdit.setObjectName(_fromUtf8("imuTopicEdit"))
        self.gridLayout.addWidget(self.imuTopicEdit, 0, 1, 1, 1)
        ...
        self.magnTopicEdit = QtGui.QLineEdit(self.gridLayoutWidget)
        self.magnTopicEdit.setObjectName(_fromUtf8("magnTopicEdit"))
        self.gridLayout.addWidget(self.magnTopicEdit, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.samplingToggleButton, 0, 8, 1, 1)
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 100, 801, 711))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 380, 791, 231))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 20, 381, 201))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(260, 620, 301, 51))
        ...
        self.magnXY_cal.setGeometry(QtCore.QRect(-10, 0, 781, 351))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
    ...
    def retranslateUi(self, FreeIMUCal):
        ...
        self.label.setText(_translate("FreeIMUCal", "ROS topic IMU", None))
        self.label_5.setText(_translate("FreeIMUCal", "ROS topic MAG", None))
        ...
        self.label_6.setText(_translate("FreeIMUCal", "Values multiplied by 1e3", None))
        self.connectButton.setToolTip(_translate("FreeIMUCal", "Connect or Disconnect from ROS topic", None))
        ...
        self.saveCalibrationHeaderButton.setToolTip(_translate("FreeIMUCal", "Store the calibration parameters in an header .h file.", None))
        self.saveCalibrationHeaderButton.setText(_translate("FreeIMUCal", "Save to calibration.json", None))
